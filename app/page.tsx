    ...
    <section className="home-visual-strip" aria-label="Projects and identity">
      <div className="home-visual-track">
        <div className="home-visual-group">
          <a href="/projects" aria-label="Projects"><img src="/ttfl.jpg" alt="" /></a>
          <a href="/about" aria-label="About"><img src="/favicon%20(1).png" alt="" /></a>
          <a href="/projects" aria-label="Projects"><img src="/ttfl.jpg" alt="" /></a>
          <a href="/about" aria-label="About"><img src="/favicon%20(1).png" alt="" /></a>
          <a href="/projects" aria-label="Projects"><img src="/ttfl.jpg" alt="" /></a>
          <a href="/about" aria-label="About"><img src="/favicon%20(1).png" alt="" /></a>
        </div>
        <div className="home-visual-group" aria-hidden="true">
          <a href="/projects" tabIndex={-1}><img src="/ttfl.jpg" alt="" /></a>
          <a href="/about" tabIndex={-1}><img src="/favicon%20(1).png" alt="" /></a>
          <a href="/projects" tabIndex={-1}><img src="/ttfl.jpg" alt="" /></a>
          <a href="/about" tabIndex={-1}><img src="/favicon%20(1).png" alt="" /></a>
          <a href="/projects" tabIndex={-1}><img src="/ttfl.jpg" alt="" /></a>
          <a href="/about" tabIndex={-1}><img src="/favicon%20(1).png" alt="" /></a>
